    ...
    <section id="how-it-works" className="py-24 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-brand-red/20 via-brand-red to-brand-red/20 transform -translate-y-1/2" />
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="bg-white rounded-3xl p-8 shadow-xl shadow-gray-100/50 border border-gray-100 relative z-10">
                  {/* Step number badge */}
                  <div className="absolute -top-4 left-8 bg-gradient-to-r from-brand-red to-brand-red-dark text-white text-sm font-bold px-4 py-2 rounded-full">
                    Step {step.number}
                  </div>

                  {/* Icon */}
                  <div className="w-16 h-16 bg-brand-red/10 rounded-2xl flex items-center justify-center mb-6 mt-4">
                ...
                {/* Timeline dot */}
                <div className="hidden lg:flex absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-brand-red rounded-full border-4 border-white shadow-lg z-20" />
              </motion.div>
            ))}
          </div>
        </div>
