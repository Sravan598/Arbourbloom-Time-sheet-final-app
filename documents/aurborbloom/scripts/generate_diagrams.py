"""Generate architecture and flow diagrams for AurborBloom BRD/FRD."""
import matplotlib.pyplot as plt
import matplotlib.patches as patches
from matplotlib.patches import FancyBboxPatch, FancyArrowPatch
import os

OUT = "/app/documents/aurborbloom/assets"
...
styled_box(ax, 8.6, 6.3, 3.0, 1.0, "Custom Domain\nhr.aurborbloom.com", fill="#FFFFFF", edge=SECONDARY)
...
ax.set_title("Figure 5 — HRMS Module Map for AurborBloom",
             fontsize=14, fontweight='bold', color=PRIMARY, pad=12)

# central
styled_box(ax, 4.5, 3.0, 3.0, 1.2, "AurborBloom HRMS\n(Multi-Tenant SaaS)", fill=PRIMARY, fontcolor='#FFFFFF', fontsize=12)
