"""
Generate FRD (Functional Requirements Document) for Perfect Solutions
in DOCX format.
"""
import os
...
spec = importlib.util.spec_from_file_location(
    "brd_helpers", "/app/documents/perfect_solutions/scripts/generate_brd_docx.py")
...
def build_frd():
    ...
    add_bullets(doc, [
        "Tenant resolution can occur via slug path (/perfectsolutions/...) or custom domain (hr.perfectsolutions.com).",
    ...
    add_table(doc, ["FR ID", "Functional Requirement", "Priority", "Trace"],
        [
            ...
            ["FR-008", "The system shall display Perfect Solutions branding (logo, colors, tab title) on all auth pages.", "Must", "BR-001"],
        ],
    ...
    add_table(doc, ["Field", "Detail"],
        [
            ...
            ["Main Flow",
             ...
             "2. System validates code against perfectsolutions tenant.\n"
    ...
    add_table(doc, ["FR ID", "Functional Requirement", "Priority", "Trace"],
        [
            ...
            ["FR-016", "Department list shall be tenant-configurable; default values for Perfect Solutions are: General, Engineering, HR, Sales, Marketing, Finance.", "Must", "BR-005"],
        ],
        col_widths=[Inches(0.7), Inches(4.4), Inches(0.7), Inches(0.6)]
    )
    ...
    add_table(doc, ["FR ID", "Functional Requirement", "Priority", "Trace"],
        [
            ...
            ["FR-037", "Default leave types for Perfect Solutions: Vacation, Sick, Personal, Unpaid.", "Must", "BR-008"],
        ],
        col_widths=[Inches(0.7), Inches(4.4), Inches(0.7), Inches(0.6)]
    )
    ...
    out = f"{OUT_DIR}/Perfect_Solutions_FRD_v1.0.docx"
    doc.save(out)
